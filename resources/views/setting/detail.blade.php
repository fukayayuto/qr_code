...
<body>
    ...
    <div class="container">
        <div class="panel panel-default">
          <div class="panel-heading">予約日時詳細</div>
          <div class="panel-body">
            <form action="{{route('setting_reservation_change')}}" method="POST">
            {{-- <form action="#" method="POST"> --}}
              ...
              <div class="form-group">
                ...
                <input class="form-control" type="number" name="progress" value="{{$data->progress}}">
              </div>
              <div class="form-group">
                <label class="control-label">定員数 </label>
                <input class="form-control" type="number" name="count" value="{{$data->count}}">
              </div>
